...
def grade(chat, prompt_template, n_limit = None):
    ...
    target_dir = uf.get_sub_dir("25Fall", "A3", "HW3b")
    rubric = uf.readReturn(os.path.abspath("A3/rubrics/A3b_rubric.txt"))
    grade_comment_template = uf.readReturn(os.path.abspath("A3/grade_comment_template.txt"))
